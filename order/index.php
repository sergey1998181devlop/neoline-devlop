...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"MESS_REGION_BLOCK_NAME" => "Адрес доставки",
		"MESS_PAYMENT_BLOCK_NAME" => "Выберите способ оплаты",
		"MESS_DELIVERY_BLOCK_NAME" => "Выберите способ доставки",
		"MESS_BUYER_BLOCK_NAME" => "Введите ваши данные",
		"MESS_BACK" => "Назад",
		"MESS_FURTHER" => "Далее",
		"MESS_EDIT" => "изменить",
