...
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/moment-with-locales.min.js', true);
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/bootstrap-datepicker.js', true);
