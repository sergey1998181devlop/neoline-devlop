...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_LINK_NEWS_ID" => "76",
		"IBLOCK_LINK_SERVICES_ID" => "77",
		"IBLOCK_LINK_TIZERS_ID" => "65",
		"IBLOCK_LINK_REVIEWS_ID" => "64",
		"IBLOCK_LINK_STAFF_ID" => "83",
		"IBLOCK_LINK_VACANCY_ID" => "57",
		"IBLOCK_LINK_BLOG_ID" => "81",
		"IBLOCK_LINK_PROJECTS_ID" => "79",
		"IBLOCK_LINK_BRANDS_ID" => "82",
		"IBLOCK_LINK_LANDINGS_ID" => "81",
